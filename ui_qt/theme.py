...
__all__ = [
    ...
    "VIEN", "XANH", "DO", "VANG", "CAM", "XAM",
    "XANH_NEN", "VANG_NEN", "DO_NEN", "XAM_NEN",
    "XANH_VIEN", "VANG_VIEN", "DO_VIEN",
    "PHONG", "PHONG_MA", "QSS", "bong",
]
...
# ── Ba mức báo trạng thái ────────────────────────────────────────────────────
#
# Thêm 21/09/2026 cho trang Trung tâm. Trước đó mỗi trang tự gõ "#B26A00",
# "#fdecea", "#9aa0a6" ở chỗ của mình — cùng một ý "đáng chú ý" mà ba trang ba
# sắc. Ba mức, mỗi mức ba màu: CHỮ (đọc được trên nền sáng), NỀN (nhạt, để
# chữ đen vẫn đọc được) và VIỀN (đậm hơn nền, cho thẻ nổi lên).
#
# Màu KHÔNG BAO GIỜ đi một mình: người dùng có thể không phân biệt được đỏ với
# vàng, nên chỗ nào đổi màu thì chỗ đó phải đổi cả CHỮ.
CAM = "#B26A00"          # "đáng chú ý" — vàng nguyên bản quá nhạt để đọc
XAM = "#9aa0a6"          # đang tắt, không tính vào vòng chạy
